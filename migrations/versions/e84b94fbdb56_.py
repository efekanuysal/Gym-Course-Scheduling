...
Revision ID: e84b94fbdb56
Revises: 
Create Date: 2025-05-25 09:41:26.946999
...
def downgrade():
    ...
    op.create_table('roomschedule',
    sa.Column('scheduleid', sa.INTEGER(), server_default=sa.text("nextval('roomschedule_scheduleid_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('roomid', sa.INTEGER(), server_default=sa.text("nextval('roomschedule_roomid_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['coursename'], ['course.coursename'], name='fk_coursename'),
    sa.ForeignKeyConstraint(['roomid'], ['room.id'], name='fk_roomid'),
    sa.ForeignKeyConstraint(['userid'], ['users.ssn'], name='fk_userid'),
    sa.PrimaryKeyConstraint('scheduleid', name='roomschedule_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('instructors',
    sa.Column('ssn', sa.VARCHAR(length=20), autoincrement=False, nullable=False),
    ...
    sa.PrimaryKeyConstraint('sign', name=op.f('membership_pkey'))
    )
    op.create_table('room',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
